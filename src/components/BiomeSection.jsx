  ...
  return (
    <section
      ...
      style={{
        ...
        width: '100%',
        margin: 0,
        padding: '2vh 2vw', // Added padding to section for breathing room
        overflow: 'hidden',
        display: 'flex',
        alignItems: 'center',
    ...
    >
      ...
      {/* Content Overlay - REDESIGNED STRUCTURE */}
      <motion.div
        ...
        style={{
          ...
          zIndex: 10,
          width: '100%',
          maxWidth: 'min(96vw, 1000px)', // Larger max width
          height: 'auto',
          maxHeight: '96vh', // Almost full viewport height
        ...
        >
          <motion.div
            style={{
              ...
              alignItems: 'center',
              paddingBottom: 'clamp(0.5rem, 2vw, 1rem)' // Extra bottom padding
            }}
          ...
          >
            {biome.content.details.map((detail, detailIndex) => (
              <motion.div
                ...
                whileHover={{ 
                  ...
                  zIndex: 10, // Ensure hover effect is visible
            ...
            {/* CV Download Button - IMPROVED POSITIONING */}
